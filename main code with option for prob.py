...
def main():
    ...
    ans_prob_data = input("Use the probability data to calculate the feature vector (y/n) -> ")
    
    print("Retrieving data...")
    image_data = get_image_data(data_type, 'auto',ans_augmented, ans_feat_vec, ans_prob_data)
    Corrected_image_data = get_image_data(data_type, 'corrected',ans_augmented, ans_feat_vec, ans_prob_data)
    patient_data = get_image_data(data_type, 'auto_feat',ans_augmented, ans_feat_vec, ans_prob_data)    
...
for classifier_type in classifier_types:
    for data_type in data_types:
        ...
        dice_score_save_folder_location = "\\Results2\\Dice_Scores_prob_data" + str(val) + data_type #"\\Results\\Dice_Scores_val_mean"
